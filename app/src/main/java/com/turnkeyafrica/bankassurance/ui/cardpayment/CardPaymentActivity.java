...
import com.turnkeyafrica.bankassurance.databinding.ActivityCardPaymentBinding;
import com.turnkeyafrica.bankassurance.ui.base.BaseActivity;
import com.turnkeyafrica.bankassurance.ui.cardpayment.carddatesdialog.CardDatesDialog;
...
public class CardPaymentActivity extends BaseActivity<ActivityCardPaymentBinding, CardPaymentViewModel> implements CardPaymentNavigator, HasAndroidInjector {
    ...
    private void initComponents() {
          ...
          creditCardNameTextInput = disableCopyAndPaste(creditCardNameTextInput);

          creditCardNumberTextInput = mActivityCardPaymentBinding.creditCardNumber;

          creditCardNumberTextInput = disableCopyAndPaste(creditCardNumberTextInput);

          creditCardMonthInput = mActivityCardPaymentBinding.creditCardMonth;

          creditCardMonthInput = disableCopyAndPaste(creditCardMonthInput);

          creditCardYearInput = mActivityCardPaymentBinding.creditCardYear;

          creditCardYearInput = disableCopyAndPaste(creditCardYearInput);

          cvvNumberTextInput = mActivityCardPaymentBinding.cvvNumberInput;

          cvvNumberTextInput = disableCopyAndPaste(cvvNumberTextInput);
    ...
    public CardDetailsRequest getCardDetails() {
        ...
        return new CardDetailsRequest(
                payAmount,
                getViewModel().getDataManager().getCurrentClientId(),
                "254",
                cardNumber,
                "KES",
                cvv,
