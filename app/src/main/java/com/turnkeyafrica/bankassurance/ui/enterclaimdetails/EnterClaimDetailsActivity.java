...
import com.turnkeyafrica.bankassurance.databinding.ActivityEnterClaimDetailsBinding;
...
public class EnterClaimDetailsActivity extends BaseActivity<ActivityEnterClaimDetailsBinding,EnterClaimDetailsViewModel> implements EnterClaimDetailsNavigator, HasAndroidInjector {
    ...
    private void initialiseComponents() {
        ...
        ClaimShortDesc = mActivityEnterClaimDetailsBinding.claimShortDesc;

        ClaimShortDesc = disableCopyAndPaste(ClaimShortDesc);

        IncidentDate = mActivityEnterClaimDetailsBinding.incidentDate;

        IncidentDate = disableCopyAndPaste(IncidentDate);

        PropertyId = mActivityEnterClaimDetailsBinding.propertyId;

        PropertyId = disableCopyAndPaste(PropertyId);
    }
    ...
    public void verifyClaimDetails() {
        ...
        String description = ClaimShortDesc.getText().toString();

        String incidentDate = IncidentDate.getText().toString();
