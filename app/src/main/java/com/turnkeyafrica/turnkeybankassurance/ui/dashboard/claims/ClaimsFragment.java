...
import com.turnkeyafrica.turnkeybankassurance.databinding.FragmentClaimsBinding;
...
public class ClaimsFragment extends BaseFragment<FragmentClaimsBinding, ClaimsViewModel>
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
       ...
       if(isNetworkConnected()) {
            mClaimsViewModel.getClaims(mClaimsViewModel.getDataManager().getCurrentUserId());
        }else {
